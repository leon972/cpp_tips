...
{
    return std::accumulate(v.begin(),v.end(),0,[](auto prev,auto v) {return prev+v;});
}
...
int main(int argc, char** argv) {
   ...
   // cout<<"*pf="<<*pf<<endl; //undefined  behaviour
    ...
    cout<<"bar=";bar.display();cout<<endl;
    ...
    const Foo foos[]={{"f1"},{"f2"},{"f3"}}; //aggregate and uniform initialization 
